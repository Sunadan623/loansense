  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (data.error) {
        ...
        navigate(data.user.role === "analyst" ? "/dashboard" : "/portal");
      }
    } catch (err) {
    ...
    <>
      ...
      <div className="auth-wrap">
        <div className="auth-card">
          ...
          <div className="auth-sub">Sign in to manage your loans</div>
          ...
          <div className="auth-footer">
            New to LoanSense? <Link to="/signup">Create an account</Link>
          </div>
        </div>
      </div>
    </>
